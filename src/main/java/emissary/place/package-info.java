/**
 * Places are for identifying, processing, transforming, and analyzing data of interest. An Emissary system is built up
 * of Places to which a {@link emissary.core.MobileAgent} can route a payload or collection of payloads. This package
